...
object FrameMethodQueueDeclareSerializer : KSerializer<Frame.Method.MethodQueue.Declare> {

    @OptIn(InternalSerializationApi::class)
    override val descriptor: SerialDescriptor
        get() = buildSerialDescriptor("Frame.Method.MethodQueue.Declare", StructureKind.OBJECT)

    override fun serialize(encoder: Encoder, value: Frame.Method.MethodQueue.Declare) {
    ...
    override fun deserialize(decoder: Decoder): Frame.Method.MethodQueue.Declare {
        ...
        return Frame.Method.MethodQueue.Declare(
            reserved1 = reserved1,
            queueName = queueName,
            passive = passive,
            durable = durable,
