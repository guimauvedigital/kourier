...
object FrameMethodExchangeUnbindSerializer : KSerializer<Frame.Method.MethodExchange.ExchangeUnbind> {

    @OptIn(InternalSerializationApi::class)
    override val descriptor: SerialDescriptor
        get() = buildSerialDescriptor("Frame.Method.MethodExchange.ExchangeUnbind", StructureKind.OBJECT)

    override fun serialize(encoder: Encoder, value: Frame.Method.MethodExchange.ExchangeUnbind) {
    ...
    override fun deserialize(decoder: Decoder): Frame.Method.MethodExchange.ExchangeUnbind {
        ...
        return Frame.Method.MethodExchange.ExchangeUnbind(
            reserved1 = reserved1,
