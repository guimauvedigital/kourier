...
object FrameMethodExchangeDeclareSerializer : KSerializer<Frame.Method.MethodExchange.Declare> {

    @OptIn(InternalSerializationApi::class)
    override val descriptor: SerialDescriptor
        get() = buildSerialDescriptor("Frame.Method.MethodExchange.Declare", StructureKind.OBJECT)

    override fun serialize(encoder: Encoder, value: Frame.Method.MethodExchange.Declare) {
    ...
    override fun deserialize(decoder: Decoder): Frame.Method.MethodExchange.Declare {
        ...
        return Frame.Method.MethodExchange.Declare(
            reserved1 = reserved1,
