...
object FrameMethodExchangeBindSerializer : KSerializer<Frame.Method.MethodExchange.Bind> {

    @OptIn(InternalSerializationApi::class)
    override val descriptor: SerialDescriptor
        get() = buildSerialDescriptor("Frame.Method.MethodExchange.Bind", StructureKind.OBJECT)

    override fun serialize(encoder: Encoder, value: Frame.Method.MethodExchange.Bind) {
    ...
    override fun deserialize(decoder: Decoder): Frame.Method.MethodExchange.Bind {
        ...
        return Frame.Method.MethodExchange.Bind(
            reserved1 = reserved1,
